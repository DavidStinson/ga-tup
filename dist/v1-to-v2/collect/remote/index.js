...
async function collect(iD) {
    ...
    iD.files.originalAssetsReadmeTemplate = await getPureFileData(files.originalAssetsReadmeTemplate, urlType);
    iD.files.fallbackCanvasLandingPageTemplate = await getPureFileData(files.fallbackCanvasLandingPageTemplate, urlType);
...
function getTemplatesThatWereNotFetched(files) {
    const templates = [
        files.defaultLayout,
        files.rootReadme,
        files.videoHub,
