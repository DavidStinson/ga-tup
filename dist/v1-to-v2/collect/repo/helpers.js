...
async function getFilesThatExist(paths) {
...
async function checkForTemplateAssetItems(dirName) {
    ...
    try {
        ...
        const containsOriginalAssets = foundAssets.includes(`${dirName}/assets/originals`);
        const containsOriginalAssetsReadme = foundAssets.includes(`${dirName}/assets/originals/README.md`);
        return {
...
export { makeTitleCase, getDirs, getFilePathsOfDirChildren, getFilesThatExist, checkForTemplateAssetItems, };
