...
// do the thing
function process(iD) {
    const isLectureModule = iD.module.meta.type === "lecture";
    ...
    iD.repoMsgs = checkCanvasLandingPages(iD.repoMsgs, iD.files.canvasLandingPages, iD.module.meta.didContainFallbackClp);
