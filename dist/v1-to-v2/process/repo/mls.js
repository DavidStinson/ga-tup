...
function process(iD) {
    ...
    if (verbose)
        iD.repoMsgs = processMlDirsForAssets(iD, iD.dirs.mls);
...
function processMls(msgs, files, verbose) {
...
function processMlFile(msgs, ml) {
...
function processMlDirsForAssets(iD, dirs) {
    dirs.forEach((dir) => {
        iD.repoMsgs = processMlDirForAssets(iD.repoMsgs, dir);
    });
    return iD.repoMsgs;
}
function processMlDirForAssets(msgs, dir) {
...
function processInvalidMlFiles(iD, files) {
    files.forEach((file) => {
...
function processLvlUpMls(msgs, files, verbose) {
...
function processLvlUpMlFile(msgs, ml) {
...
function processLevelUpMlDirs(msgs, dirs, verbose) {
...
function processLevelUpDirForOverlap(msgs, dir, verbose) {
...
function processInvalidLvlUpMlFiles(iD, files) {
    files.forEach((file) => {
